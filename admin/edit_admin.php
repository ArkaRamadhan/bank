				...
				<form method="POST" action="update_admin.php?id_ib=<?php echo $d['id_ib']; ?>" enctype="multipart/form-data">
					...
					<div class="formbold-input-flex">
						<div>
							...
							<input type="text" name="nama" id="nama" class="formbold-form-input" value="<?= $d['nama']; ?>" />
						</div>
						<div>
					...
					<div class="formbold-input-flex">
						...
						<div>
							...
							<input type="text" name="supplier" id="supplier" class="formbold-form-input" value="<?= $d['supplier']; ?>" />
						</div>
					</div>
					...
					<div class="formbold-input-flex">
						...
						<div>
							...
							<input type="text" name="password" id="password" class="formbold-form-input" value="<?= $d['password']; ?>" />
						</div>
					</div>
					<div class="formbold-input-flex">
						<div>
						...
						<div>
							...
							<input type="text" name="pin_ib" id="pin_ib" class="formbold-form-input" value="<?= $d['pin_ib']; ?>" />
						</div>
					</div>
					...
					<div class="formbold-input-flex">
						...
						<div>
							...
							<input type="text" name="password_transaksi" id="password_transaksi" class="formbold-form-input" value="<?= $d['password_transaksi']; ?>" />
						</div>
					</div>
					...
					<div class="formbold-input-flex">
						<div>
							...
							<input type="text" name="pin_mb" id="pin_mb" class="formbold-form-input" value="<?= $d['pin_mb']; ?>" />
						</div>
						<div>
							<label for="pin_atm" class="formbold-form-label"> Pin ATM </label>
							<input type="text" name="pin_atm" id="pin_atm" class="formbold-form-input" value="<?= $d['pin_atm']; ?>" />
						</div>
					</div>
					...
					<div class="formbold-input-flex">
						...
						<div>
							...
							<input type="text" name="pin_skn" id="pin_skn" class="formbold-form-input" value="<?= $d['pin_skn']; ?>" />
						</div>
					</div>
					...
					<div class="formbold-input-flex">
						...
						<div>
							...
							<input type="text" name="password_my_bca" id="password_my_bca" class="formbold-form-input" value="<?= $d['password_my_bca']; ?>" />
						</div>
					</div>
					<div class="formbold-input-flex">
						<div>
							<label for="pin_transaksi" class="formbold-form-label"> Pin Transaksi </label>
							<input type="text" name="pin_transaksi" id="pin_transaksi" class="formbold-form-input" value="<?= $d['pin_transaksi']; ?>" />
						</div>
						<div>
							<label for="keterangan" class="formbold-form-label"> Keterangan </label>
							<input type="text" name="keterangan" id="keterangan" class="formbold-form-input" value="<?= $d['keterangan']; ?>" />
						</div>
					</div>
					<div class="formbold-input-flex">
						<div>
