            ...
            <form action="aksi_admin.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="formbold-input-flex">
                    ...
                    <div>
                        ...
                        <input type="text" name="supplier" id="supplier" class="formbold-form-input" />
                    </div>
                </div>
                ...
                <div class="formbold-input-flex">
                    ...
                    <div>
                        ...
                        <input type="text" name="password" id="password" class="formbold-form-input" />
                    </div>
                </div>
                <div class="formbold-input-flex">
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="pin_ib" id="pin_ib" class="formbold-form-input" />
                    </div>
                </div>
                ...
                <div class="formbold-input-flex">
                    ...
                    <div>
                        ...
                        <input type="text" name="password_transaksi" id="password_transaksi" class="formbold-form-input" />
                    </div>
                </div>
                ...
                <div class="formbold-input-flex">
                    <div>
                        ...
                        <input type="text" name="pin_mb" id="pin_mb" class="formbold-form-input" />
                    </div>
                    <div>
                        <label for="pin_atm" class="formbold-form-label"> Pin ATM </label>
                        <input type="text" name="pin_atm" id="pin_atm" class="formbold-form-input" />
                    </div>
                </div>
                ...
                <div class="formbold-input-flex">
                    ...
                    <div>
                        ...
                        <input type="text" name="pin_skn" id="pin_skn" class="formbold-form-input" />
                    </div>
                </div>
                ...
                <div class="formbold-input-flex">
                    ...
                    <div>
                        ...
                        <input type="text" name="password_my_bca" id="password_my_bca" class="formbold-form-input" />
                    </div>
                </div>
                <div class="formbold-input-flex">
                    <div>
                        <label for="pin_transaksi" class="formbold-form-label"> Pin Transaksi </label>
                        <input type="text" name="pin_transaksi" id="pin_transaksi" class="formbold-form-input" />
                    </div>
                    <div>
