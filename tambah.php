								...
								<div class="card-body">
									<form method="POST" action="tambah_aksi.php" enctype="multipart/form-data">
										...
										<div class="row">
												...
												<select name="status" id="genre" class="form-select col" aria-label="Default select example" style="height:3.6rem;margin-left:12px">
											...
											<div class="form-floating mb-3 col">
												<input class="form-control" id="inputPassword" type="text"
													placeholder="Password" name="saldo" />
										...
										<div class="form-floating mb-3 col">
											<input class="form-control" id="inputPassword" type="text"
												placeholder="Password" name="jenis_kartu" />
