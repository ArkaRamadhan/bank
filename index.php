                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="gambar/<?php echo $d['foto_ktp'] ?>" width="35" height="40">
                                                </td>
    
                                                <td>
                                                    <a href="edit.php?id_ib=<?php echo $d['id_ib']; ?>"  class="btn btn-outline-success" style="width: 77px;">EDIT</a>
                                                    <a href="hapus.php?id_ib=<?php echo $d['id_ib']; ?>" class="btn btn-outline-danger">HAPUS</a>
                                                </td>
