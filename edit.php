								...
								<div class="card-body">
									...
									while ($d = mysqli_fetch_array($data)) {
										...
										<form method="POST" action="update.php" enctype="multipart/form-data">
											...
											<input type="hidden" name="id_ib" value="<?= $d['id_ib'] ?>">
											<input class="form-control" id="nama" type="text" placeholder="Nama"
												name="bank" value="<?= $d['bank'] ?>"/>
										...
										<div class="row">
											...
											<div class="form-floating mb-3 col">
												...
												<input class="form-control" id="inputPenerbit" type="text" placeholder="Nama"
													name="nama_ibu" value="<?= $d['nama_ibu'] ?>"/>
										...
										<div class="row">
											<div class="form-floating mb-3 col">
												<input type="hidden" name="id_admin">
												<input class="form-control" id="nama" type="text" placeholder="Nama"
													name="no_rek" value="<?= $d['no_rek'] ?>"/>
												<label for="nama" style="margin-left:12px">NO REK</label>
											</div>
											<div class="form-floating mb-3 col">
												<input type="hidden" name="id_admin">
												<input class="form-control" id="inputPenerbit" type="text" placeholder="Nama"
													name="no_atm" list="penerbit" value="<?= $d['no_atm'] ?>"/>
										...
										<div class="row">
											<div class="form-floating mb-3 col">
												<input type="hidden" name="id_admin">
												<input class="form-control" id="nama" type="text" placeholder="Nama"
													name="pin_atm" value="<?= $d['pin_atm'] ?>"/>
												<label for="nama" style="margin-left:12px">PIN ATM</label>
											</div>
											<div class="form-floating mb-3 col">
												<input type="hidden" name="id_admin">
												<input class="form-control" id="inputPenerbit" type="text" placeholder="Nama"
													name="no_hp" value="<?= $d['no_hp'] ?>"/>
										...
										<div class="row">
												...
												<select name="status" id="genre" class="form-select col" aria-label="Default select example" style="height:3.6rem;margin-left:12px" value="<?= $d['status'] ?>">
											...
											<div class="form-floating mb-3 col">
												<input class="form-control" id="inputPassword" type="text"
													placeholder="Password" name="saldo" value="<?= $d['saldo']?>"/>
										...
										<div class="form-floating mb-3 col">
											<input class="form-control" id="inputPassword" type="text"
												placeholder="Password" name="jenis_kartu" value="<?= $d['jenis_kartu'] ?>"/>
